...
Feature: Create Entry
  ...
  Scenario: Create entry
    ...
    When I send a POST request to "https://hub.retext.it.dev/api/bcrm/bcrm14" with JSON values:
      | type        | session                   |
    ...
    And the header "location" should match "%^https://hub\.retext\.it\.dev/api/bcrm/bcrm14/[0-9a-f]{32}$%"
